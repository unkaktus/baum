...
/* important note
   ...
   and it used e.g. for the largangian interpolation of the metric part.
...
double interpolate_linear_avg(int N, double x, double x0, double h, double *c, double *u)
{

  int i = N/2-1;
  double ooh = 1./h;
  double dx  = x - x0; 
  double ux  = 0.5*(u[i] + u[i+1]);
