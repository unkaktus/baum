...
const int store          = Getv("bssn_register_algcon", "store");
...
if (detg<=0.01) { PROBLEM; /*errorexit(" detg <= 0.");*/ }  
...
} endfor_ijk_openmp; /*  if (stop) errorexit(""); */ /* loop ijk */
...
/* bssn_algcon.c */
/* nvars = 14, nauxs = 5, n* = 122,  n/ = 36,  n+ = 50, n = 208, O = 0 */
