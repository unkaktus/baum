...
(* compute right hand side of GRHD equations, avoid producinh NANs *)
...
tocompute = {
    ...
    Cinstruction == "} else {",
        ...
        Cinstruction == "errorexit(\"alpha[ijk]<=ALPHAMIN\");",
        Cinstruction == "}",
                
        Cinstruction == "if(CheckForNANandINF(11,MD[ijk],MS1[ijk],MS2[ijk],MS3[ijk],Mtau[ijk],Mrho[ijk],Mepsl[ijk],Mp[ijk],Mv1[ijk],Mv2[ijk],Mv3[ijk])) {",
        Cinstruction == "  errorexit(\"found NAN/INF\");",
        Cinstruction == "}",
        ...
        v[a]   == g[a,b] Mv[b],
        vsq    == vup[a] v[a],
        Cinstruction == "if(vsq>=1.0) W = GRHD.HRSC_WlorMAX;",
        Cinstruction == "else {",
          W == 1/sqrt[1-vsq],        
        Cinstruction == "}",
