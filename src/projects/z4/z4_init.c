...
void z4_init(tVarList *ucur)
{

tL *level = ucur->level;
double *gb11 = vldataptr(ucur, METRIC_z4_INDX_VAR);
double *gb12 = vldataptr(ucur, 1 + METRIC_z4_INDX_VAR);
double *gb13 = vldataptr(ucur, 2 + METRIC_z4_INDX_VAR);
double *gb22 = vldataptr(ucur, 3 + METRIC_z4_INDX_VAR);
double *gb23 = vldataptr(ucur, 4 + METRIC_z4_INDX_VAR);
double *gb33 = vldataptr(ucur, 5 + METRIC_z4_INDX_VAR);
double *Kb11 = vldataptr(ucur, 6 + METRIC_z4_INDX_VAR);
double *Kb12 = vldataptr(ucur, 7 + METRIC_z4_INDX_VAR);
double *Kb13 = vldataptr(ucur, 8 + METRIC_z4_INDX_VAR);
double *Kb22 = vldataptr(ucur, 9 + METRIC_z4_INDX_VAR);
double *Kb23 = vldataptr(ucur, 10 + METRIC_z4_INDX_VAR);
double *Kb33 = vldataptr(ucur, 11 + METRIC_z4_INDX_VAR);
double *gt11 = vldataptr(ucur, 12 + METRIC_z4_INDX_VAR);
double *gt12 = vldataptr(ucur, 13 + METRIC_z4_INDX_VAR);
double *gt13 = vldataptr(ucur, 14 + METRIC_z4_INDX_VAR);
double *gt22 = vldataptr(ucur, 15 + METRIC_z4_INDX_VAR);
double *gt23 = vldataptr(ucur, 16 + METRIC_z4_INDX_VAR);
double *gt33 = vldataptr(ucur, 17 + METRIC_z4_INDX_VAR);
double *chi = vldataptr(ucur, 18 + METRIC_z4_INDX_VAR);
double *At11 = vldataptr(ucur, 19 + METRIC_z4_INDX_VAR);
double *At12 = vldataptr(ucur, 20 + METRIC_z4_INDX_VAR);
double *At13 = vldataptr(ucur, 21 + METRIC_z4_INDX_VAR);
double *At22 = vldataptr(ucur, 22 + METRIC_z4_INDX_VAR);
double *At23 = vldataptr(ucur, 23 + METRIC_z4_INDX_VAR);
double *At33 = vldataptr(ucur, 24 + METRIC_z4_INDX_VAR);
double *K = vldataptr(ucur, 25 + METRIC_z4_INDX_VAR);
double *G1 = vldataptr(ucur, 26 + METRIC_z4_INDX_VAR);
double *G2 = vldataptr(ucur, 27 + METRIC_z4_INDX_VAR);
double *G3 = vldataptr(ucur, 28 + METRIC_z4_INDX_VAR);
double *gtinv11 = vldataptr(ucur, 29 + METRIC_z4_INDX_VAR);
double *gtinv12 = vldataptr(ucur, 30 + METRIC_z4_INDX_VAR);
double *gtinv13 = vldataptr(ucur, 31 + METRIC_z4_INDX_VAR);
double *gtinv22 = vldataptr(ucur, 32 + METRIC_z4_INDX_VAR);
double *gtinv23 = vldataptr(ucur, 33 + METRIC_z4_INDX_VAR);
double *gtinv33 = vldataptr(ucur, 34 + METRIC_z4_INDX_VAR);
double *Theta = vldataptr(ucur, 35 + METRIC_z4_INDX_VAR);
...
if (detgt<=0.00001) printf("detg<0 :  %e %e %e\n",detgb,detgt,chi[ijk]); 
...
/* z4_init.c */
/* nvars = 41, nauxs = 82, n* = 269,  n/ = 48,  n+ = 291, n = 608, O = 0 */
