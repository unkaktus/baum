...
(* Z4c_boundary_box.m sb 02/15  -> attempt to have CPBC on boxes *)
...
(************************************************************************)
    ...
    Cinstruction == "if (!(give_cube_normal (i,j,k, imax,jmax,kmax,N_points_away, &shat1,&shat2,&shat3)))
     errorexit(\"not at boundary\");",

  (*
  Cinstruction == "printf(\"(%g %g %g) => (%g %g %g)\\n\",xp[ijk],yp[ijk],zp[ijk],shat1,shat2,shat3);",
   *)
